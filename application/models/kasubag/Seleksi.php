...
class Seleksi extends CI_Model {
  ...
  var $table = "bea";
  var $select_column = array("bea.id", "bea.namaBeasiswa", "bea.penyelenggaraBea", "bea.selektor", "bea.kuota", "bea.statusBeasiswa");
  var $order_column = array("bea.id", "bea.namaBeasiswa", "bea.penyelenggaraBea", "bea.selektor", "bea.kuota", null);
