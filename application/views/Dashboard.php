    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m8 l8 offset-m2">
                ...
                <span class="copyrights">&copy; 2017. Made with <i class="ion-android-favorite"></i> Allright Reserved By <a href="https://genbidev.github.io" target="_blank">GENBI UIN Maliki Malang Developer</a></span>
                </div>
            </div>
        </div>
    </div><!-- Container ends -->
