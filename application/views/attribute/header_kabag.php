...
<head>
  ...
  <title>Beasiswa | Kabag Kemahasiswaan</title>
...
<header>
  ...
  <div class="navbar-fixed hide-on-large-only">
    <nav>
      <div class="nav-wrapper">
        <ul class="right">
          <li class="hide-on-small-only"><a href="<?php echo base_url();?>kabag/C_kabag/profile"><i class="mdi-action-perm-identity"></i></a></li>
  ...
  <div id="slide-menu" class="side-nav fixed" data-simplebar-direction="vertical">
    <ul class="side-nav-main">
      ...
      <li class="side-nav-inline hide-on-med-only"><a href="#" onClick="logout()" class="inline waves-effect" title="Logout"><i class="mdi-action-exit-to-app"></i></a> <a href="<?php echo base_url();?>kabag/C_kabag/profile" class="inline waves-effect" title="Profile"><i class="mdi-action-perm-identity"></i></a> </li>
      <li><a href="#" class="waves-effect"><i class="mdi-action-dashboard left"></i><span>Beranda</span></a></li>
      <li><a href="<?php echo base_url();?>kabag/C_kabag/profile" class="waves-effect"><i class="mdi-action-account-box left"></i><span>User Profile</span></a></li>
      <li>
        <ul class="collapsible" data-collapsible="accordion">
          <li><a class="collapsible-header waves-effect"><i class="mdi-action-settings left"></i><span>Kontrol Pendaftaran</span><span class="neutral badge">2</span></a>
          ...
          <li><a href="<?php echo base_url('kabag/C_kabag/Pemohon');?>" class="waves-effect"><i class="mdi-maps-local-print-shop left"></i><span>Lap.Pemohon Beasiswa</span></a></li>
          <li><a href="<?php echo base_url('kabag/C_kabag/Penerima');?>" class="waves-effect"><i class="mdi-maps-local-print-shop left"></i><span>Lap.Penerima Beasiswa</span></a></li>
          <li><a href="<?php echo base_url('kabag/C_kabag/viewGrafik');?>" class="waves-effect"><i class="mdi-maps-local-print-shop left"></i><span>Lap.Grafik</span></a></li>
        </ul>
      </li>
    </ul>
  </div>
