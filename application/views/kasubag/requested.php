        ...
        <div id="responsive" class="section">
          <div class="row">
            <div class="col s6">
              <h4>
                List Beasiswa
                <a href="<?php echo base_url('kasubag/C_requested/pengaturan')?>" class="btn-floating waves-effect waves-light primary-color z-depth-0" title="Tambah Data"><i class="material-icons">add</i></a>
              </h4>
            </div>
            <div class="col s6">
              <p>
