				...
				<div class="row">
					...
					<div class="col s12">
						<div class="card-panel no-padding">
									...
									<div class="form-pad">
										...
										<div class="row">
											<div class="col s12 m8 push-m4">
												<a href="<?php echo base_url('kasubag/Kasubag/profile') ?>" class="modal-action modal-close waves-effect red btn"><i class="mdi-navigation-cancel left"></i>Cancel</a>
							...
							<!-- Password tab START -->
							<div id="password">
								<form method="post" onsubmit="return cekform();" action="<?php echo base_url(); ?>kasubag/C_profileKasubag/simpanPassword">
									<div class="form-pad">
										<div class="row">
											<div class="col s12">
												<div class="input-field">
