<main>
	<div class="container">
		<h4><span class="blue-text">Profile Kasubag Fakultas <b><?php echo $id;?></b></span></h4>
		<!--  Tables Section-->
				...
				<div class="row">
					...
					<div class="col s12">
						<div class="card-panel no-padding">
							<!-- Personal tab START -->
							<div id="personal">
								<form method="post" action="<?php echo base_url(); ?>kasubag_fakultas/C_profileKasubagFk/simpan" enctype="multipart/form-data">
									<div class="form-pad">
										<div class="row">
													...
													<div class="form-pad center-align col s12 m6 offset-m3">
														...
														<div class="file-field input-field">
															<div class="btn no-float primary-color">
																...
																<input type="hidden" name="id" class="form-control" value="<?php echo $idpr;?>">
										...
										<div class="row">
											<div class="col s12 m8 push-m4">
												<a href="<?php echo base_url('kasubag_fakultas/C_kasubagfk/profile') ?>" class="modal-action modal-close waves-effect red btn"><i class="mdi-navigation-cancel left"></i>Cancel</a>
