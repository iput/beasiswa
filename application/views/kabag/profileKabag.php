<main>
	<div class="container">
		<h3><span class="blue-text">Profile Kabag</span></h3>
		<!--  Tables Section-->
				...
				<div class="row">
					...
					<div class="col s12">
						<div class="card-panel no-padding">
							<!-- Personal tab START -->
							<div id="personal">
								<form method="post" action="<?php echo base_url(); ?>kasubag/C_profileKasubag/simpan" enctype="multipart/form-data">
									<div class="form-pad">
										<div class="row">
										...
										<div class="row">
											<div class="col s12 m8 push-m4">
												<a href="<?php echo base_url('kabag/C_kabag/profile') ?>" class="modal-action modal-close waves-effect red btn"><i class="mdi-navigation-cancel left"></i>Cancel</a>
							...
							<!-- Password tab START -->
							<div id="password">
								<form method="post" onsubmit="return cekform();" action="<?php echo base_url(); ?>kabag/C_profileKabag/simpanPassword">
									<div class="form-pad">
										<div class="row">
											<div class="col s12">
												<div class="input-field">
